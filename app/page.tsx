...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex flex-1 w-full max-w-container flex-col items-center justify-between bg-white px-4 py-16 dark:bg-black sm:px-8 sm:py-24 sm:items-start lg:px-16 lg:py-32">
        <Image
